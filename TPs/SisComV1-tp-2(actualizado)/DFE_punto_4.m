...
% h = [0.0099 0.0153 0.0270 0.0588 0.2000 1 0.2000 0.0588 0.0270 0.0153 0.0099];
...
simbolos=1000; %mil son en el ejrcicio
...
title('evolcion de los coeficientes de ambos filtros')
...
title('evolcion de los coeficientes del filtro directo')
...
title('evolcion de los coeficientes del filtro retroalimentado')
