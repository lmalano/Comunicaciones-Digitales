...
%Parámetros
DataLength = 100;         % Cantidad de símbolos a transmitir (1000000)
...
EsNodB = 2;               % Determina la relación en decibeles entre la energia del símbolo Es y la densidad espectral de potencia de ruido No
EsNo = 10.^(EsNodB/10);
...
for m = 2*L+1:figure(5)
d = 5; %Delay para centrar el ojo
for m = 2*L+1:DataLength-(2*L+1)
