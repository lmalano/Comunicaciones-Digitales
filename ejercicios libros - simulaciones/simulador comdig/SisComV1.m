...
%Parámetros
DataLength = 800000;         % Cantidad de símbolos a transmitir
...
EsNo = 10.^(EsNodB/10);
SwitchSignal = 'RealData';  % 'RandomData': Datos binarios generados con una distribición uniforme  
